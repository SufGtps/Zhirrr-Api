...
var creatorList = ['@suf','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@sufgnsapisss','@zhirrganteng','@zahirrgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'sufgnsapi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'sufgnsapi') return res.json(loghandler.invalidKey)
